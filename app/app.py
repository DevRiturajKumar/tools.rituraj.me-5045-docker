...
def get_skills_data():
    ...
    return {
        'lookup': {
            ...
            'label': '🔍 Lookup',
                'label_clean': 'Lookup',
                'icon_svg': '''<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>''',
            'skills': {
                'domain-lookup': {
                    'label': 'Domain Lookup',
        ...
        'social': {
            ...
            'label': '📨 Social',
                'label_clean': 'Social',
                'icon_svg': '''<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>''',
            'skills': {
                'email-sender': {
                    'label': 'Send Email',
        ...
        'content': {
            ...
            'label': '📝 Content',
                'label_clean': 'Content',
                'icon_svg': '''<svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>''',
            'skills': {
                'flashcards-creator': {
                    'label': 'FlashCards',
